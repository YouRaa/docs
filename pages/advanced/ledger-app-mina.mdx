...
Загрузите [Последний Релиз Ledger App Mina](https://github.com/jspada/ledger-app-mina/releases/latest) с Github.  Мы тестируем версию 1.0.0-beta.4
...
Примечание: Вы можете удалить его с помощью `uninstall.sh`, если у вас установлена предыдущая версия.
...
Это запустит процесс установки приложения (продолжаящийся в следующих шагах).
