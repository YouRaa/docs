...
Загрузите [Последний Релиз Ledger App Mina](https://github.com/jspada/ledger-app-mina/releases/latest) на Github.  Мы тестируем версию 1.0.0-beta.4
...
Важно: Если вы проверили контрольную сумму на шаге (6), вы можете игнорировать открытые ключи, указанные выше, а также «Идентификатор приложения» и «Полный хэш приложения» на следующих шагах. Эти предупреждения вызваны тем, что ledger-app-mina еще не является утвержденным Ledger приложением.
...
Для более детальной информации посетите [вебсайт Homebrew](https://brew.sh/)
...
### 4) Установите ledger-app-mina

Загрузите [Последний Релиз Ledger App Mina](https://github.com/jspada/ledger-app-mina/releases/latest) на Github.
...
Важно: Если вы проверили контрольную сумму на шаге (5), вы можете игнорировать открытые ключи, указанные выше, а также «Идентификатор приложения» и «Полный хэш приложения» на следующих шагах. Эти предупреждения вызваны тем, что ledger-app-mina еще не является утвержденным Ledger приложением.
