...
**Архивная нода** - это обычный daemon mina, подключенный к запущенному процессу архивирования.
Daemon будет регулярно отправлять данные блокчейна в процесс архивации,
